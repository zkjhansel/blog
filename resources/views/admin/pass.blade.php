    ...
    <form method="post" action="">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <input type="password" name="old_pass"> </i>请输入原始密码</span>
                </td>
            </tr>
            <tr>
                <th><i class="require">*</i>新密码：</th>
                <td>
                    <input type="password" name="new_pass"> </i>新密码6-20位</span>
                </td>
            </tr>
            <tr>
                <th><i class="require">*</i>确认密码：</th>
                <td>
                    <input type="password" name="new_pass_confirmation"> </i>再次输入密码</span>
                </td>
            </tr>
            <tr>
                <th></th>
